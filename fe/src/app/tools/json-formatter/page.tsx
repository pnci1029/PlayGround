        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-96 bg-white border border-border text-gray-900 p-4 rounded-lg font-mono text-sm resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-96 bg-white border border-border text-gray-900 p-4 rounded-lg font-mono text-sm resize-none focus:outline-none"
            />
          </div>
        </div>
