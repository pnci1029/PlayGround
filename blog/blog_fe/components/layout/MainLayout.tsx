          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex items-center space-x-6">
                ...
                <Link href={"/category/dev" as Route} className="text-text-secondary hover:text-primary transition-colors">
                  개발
                </Link>
                <Link href={"/category/reading" as Route} className="text-text-secondary hover:text-primary transition-colors">
                  독서
                </Link>
                <Link href={"/search" as Route} className="text-text-secondary hover:text-primary transition-colors">
                  검색
                </Link>
              </nav>
            </div>
