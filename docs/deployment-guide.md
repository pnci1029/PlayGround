...
### 서비스별 포트 매핑
| 서비스 | Frontend | Backend API | WebSocket | 비고 |
|--------|----------|-------------|-----------|------|
| **Playground** | 3000 | 8000 | 8010 | 메인 서비스 |
| **MoodBite** | 3001 | 8082 | 8084 | 음식 추천 |
| **Trend** | 3003 | 8002 | 8012 | 트렌드 분석 |
...
### 환경변수 설정 원칙
- **브라우저 접근**: `localhost:포트` 사용 (컨테이너 이름 사용 불가)
- **서버 간 통신**: 컨테이너 이름 사용 (`playground_backend`, `moodbite_backend`, etc.)
